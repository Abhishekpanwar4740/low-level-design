...
import com.example.demo.carRentalSystemDesign.product.Car;
...
public class Main {
    public static void main(String args[]) {
        ...
        Location location = new Location("591 26D cross rd", "Bangalore", "Karnataka", "India",403012);
        ...
        store.completeReservation(reservation.resId);
